  ...
  return (
    <View style={{flex:1, marginTop:30}}>
        <View style={{paddingHorizontal:16, marginTop:85, alignItems:"center"}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Daftar')} style={{width:320, height:40, marginBottom:12, backgroundColor:"#7C7CFC", alignItems:"center", justifyContent:"center", borderRadius:5}}>
            ...
            <View style={{marginTop:25, width:320, height:200, backgroundColor:"#004DA3", borderRadius:5, alignItems:"center", paddingVertical:15, paddingHorizontal:12}}>
                ...
                <TouchableOpacity style={{width:285, height:40, marginBottom:12, backgroundColor:"#7C7CFC", alignItems:"center", justifyContent:"center", borderRadius:5, marginTop:10}}>
